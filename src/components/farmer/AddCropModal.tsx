...
import { queueOfflineAction, saveCropDraft } from '../../services/offlineSyncService';
...
export const AddCropModal: React.FC<AddCropModalProps> = ({
  ...
  const handleSubmitListing = () => {
    ...
    if (typeof navigator !== 'undefined' && !navigator.onLine) {
      queueOfflineAction({
        type: 'SAVE_CROP',
        payload: completeCrop,
      });
      const validDraftGrade = completeCrop.grade === 'PREMIUM' || completeCrop.grade === 'STANDARD' ? completeCrop.grade : 'UNVERIFIED';
      saveCropDraft({
        cropName: completeCrop.name,
        variety: completeCrop.variety,
        quantityKg: completeCrop.quantityKg,
        expectedPrice: completeCrop.expectedPrice,
        grade: validDraftGrade,
        storageLocation: completeCrop.storageLocation,
        capturedViaCamera: completeCrop.capturedViaCamera,
      });
    }
