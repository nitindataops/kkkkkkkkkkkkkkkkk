...
export const VoiceAssistantView: React.FC<VoiceAssistantViewProps> = ({
  ...
  const handleStartListening = () => {
    ...
    recognition.onerror = (event: any) => {
      ...
      console.warn(
        '[KisanSetu Voice] Recognition status:',
        err
      );
      ...
      if (err === 'network') {
        const networkNotice = isHindi
          ? 'माइक्रोफ़ोन नेटवर्क सेवा अस्थायी रूप से अनुपलब्ध है। कृपया नीचे लिखकर पूछें।'
          : 'Voice network service is temporarily unavailable in this environment. You can type your query in the box below.';
        setAssistantReply(networkNotice);
      } else if (err === 'not-allowed' || err === 'service-not-allowed') {
        const permNotice = isHindi
          ? 'माइक्रोफ़ोन की अनुमति नहीं मिली। कृपया ब्राउज़र सेटिंग्स में माइक्रोफ़ोन की अनुमति दें या नीचे लिखें।'
          : 'Microphone permission was denied. Please allow microphone access or type your query below.';
        setAssistantReply(permNotice);
      }
    };
    ...
    try {
      ...
      console.warn(
        '[KisanSetu Voice] Speech recognition notice:',
        error
      );
